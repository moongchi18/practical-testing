...
class ProductControllerTest extends ControllerTestSupport {
    ...
    @Test
    @DisplayName("신규 상품ㅇ르 등록할 때 상품 타입은 필수값이다.")
    ...
    @Test
    @DisplayName("신규 상품을 등록할 때 가격은 양수여야합니다.")
    public void createProductPriceUnderZero() throws Exception {
        // given
        ProductCreateRequest request = ProductCreateRequest.builder()
                .type(ProductType.HANDMADE)
                .sellingStatus(ProductSellingStatus.SELLING)
    ...
    public void getSellingProducts() throws Exception {
        ...
        when(service.getSellingProducts()).thenReturn(result);
